    ...
    <div id="dcMain">
        ...
        <div id="urHere">DouPHP 管理中心<b>></b><strong>产品添加</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            <div class="idTabs">
                ...
                <form action="product_add_exec" method="post" enctype="multipart/form-data">
                <div class="items">
                    <div id="basic">
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"  name="p_name" value="" size="20" class="inpMain" placeholder="产品名称" required/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" height="35" align="right">产品货号</td>
                                    <td>
                                        <input type="text"  name="p_sn" value="" size="20" class="inpMain" placeholder="产品货号"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"  name="price" value="" size="5" class="inpMain" placeholder="产品价格" required/>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="35" align="right">库存量</td>
                                    <td>
                                        <input type="text" name="num" value="50" size="5" class="inpMain" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!--endueditor-->
                                        <textarea id="editor" type="text/plain"  name="detail" style="width:780px;height:400px;" required></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                    ...
                    <div id="other">
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="d_offer" cols="60" rows="4" class="textArea" required></textarea>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div id="album">
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
                                <tr align="center">
                                    <td>
                                        图片描述 <input type="text" name="a_desc" value="" size="30" class="inpMain" required/>
