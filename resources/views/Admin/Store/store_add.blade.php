...
<div id="dcWrap">
    ...
    <div id="dcMain">
        ...
        <div id="urHere">DouPHP 管理中心<b>></b><strong>新增门店</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="store_list" class="actionBtn">门店列表</a>新增门店</h3>
            <form id="myform" action="store_adds" method="post" enctype="multipart/form-data" >
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    <tr>
                        <td width="90" align="right">门店名称:</td>
                        <td>
                            <input type="text" name="s_name" id="s_name" value="" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">门店电话:</td>
                        <td>
                            <input type="text" id="s_tel" name="s_tel" value="" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top">门店描述</td>
                        <td>
                            <!-- KindEditor -->
                            ...
                            <script>
                                KindEditor.ready(function(K) {
                                    var editor1 = K.create('textarea[name="s_desc"]', {
                            ...
                            <!-- /KindEditor -->
                            <textarea id="s_desc" name="s_desc" style="width:780px;height:200px;" class="textArea"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">门店地址</td>
                        <td>
                            <input type="text" id="s_address" name="s_address" value="" size="50" class="inpMain" /><span>填写（市，区，街道，详细地址）</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">门店图片</td>
                        <td>
                            <input type="file" id="s_img" name="s_img" size="38" class="inpFlie" />
