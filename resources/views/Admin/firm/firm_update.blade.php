...
<div id="dcWrap">
    ...
    <div id="dcMain">
        ...
        <div id="urHere">DouPHP 管理中心<b>></b><strong>新增门店</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            <form id="myform" action="firm_updates" method="post" enctype="multipart/form-data" >
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    <tr>
                        <td width="90" align="right">企业名称:</td>
                        <td>
                            <input type="hidden" name="f_id" value="{{$info[0]->f_id}}">
                            <input type="text" name="f_name" id="s_name" value="{{$info[0]->f_name}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- /KindEditor -->
                            <textarea id="f_nickname" name="f_nickname" value="{{$info[0]->f_nickname}}" style="width:780px;height:200px;" class="textArea"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业LOGO</td>
                        <td>
                            <input type="file" id="f_img" name="f_img" value="{{$info[0]->f_logo}}" size="38" class="inpFlie" />
                            <img src="/public/images/icon_no.png"></td>
                    </tr>
                    <tr>
                        <td align="right">企业电话:</td>
                        <td>
                            <input type="text" id="f_tel" name="f_tel" value="{{$info[0]->f_tel}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业手机:</td>
                        <td>
                            <input type="text" id="f_phone" name="f_phone" value="{{$info[0]->f_phone}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">联系人:</td>
                        <td>
                            <input type="text" id="f_contact" name="f_contact" value="{{$info[0]->f_contact}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业邮箱:</td>
                        <td>
                            <input type="text" id="f_email" name="f_email" value="{{$info[0]->f_email}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业网址:</td>
                        <td>
                            <input type="text" id="f_url" name="f_url" value="{{$info[0]->f_url}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业地址:</td>
                        <td>
                            <input type="text" id="f_address" name="f_address" value="{{$info[0]->f_address}}" size="80" class="inpMain" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">企业视频:</td>
                        <td>
                            <input type="file" id="f_video" name="f_video" value="{{$info[0]->f_video}}" size="80" class="inpMain" />
                        </td>
                    </tr>
